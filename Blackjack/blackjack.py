...
import random
print(L)
def yes(user, computer):
    number = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
    card1 = int(random.choice(number))
    computer2 = int(random.choice(number))
    user = user + card1
    if computer < 17:
